...
public class Account_AU {
	public static void main(String[] args) throws InterruptedException {
		...
		actions.moveToElement(address1).click().sendKeys("553 St. Kilda Road");
		...
		actions.moveToElement(city).click().sendKeys("Melbourne");
		actions.build().perform();

		WebElement state = driver.findElement(By.id("adr_StateOrRegion"));
		actions.moveToElement(state).click().sendKeys("VIC");
		actions.build().perform();

		WebElement zip = driver.findElement(By.id("adr_PostalCode"));
		actions.moveToElement(zip).click().sendKeys("3004");
		actions.build().perform();
		...
		driver.findElement(By.xpath("(//li[text()='AU'])[1]")).click();

		driver.findElement(By.xpath("(//ul[@class='chosen-choices'])[2]")).click();

		driver.findElement(By.xpath("(//li[text()='AU'])[2]")).click();

		driver.findElement(By.xpath("(//ul[@class='chosen-choices'])[3]")).click();

		driver.findElement(By.xpath("(//li[text()='AU'])[3]")).click();
