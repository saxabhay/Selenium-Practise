...
public class Account_Brazil {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//span[text()='Gerencie seu conteúdo e dispositivos'])[3]")).click();

		driver.findElement(By.xpath("//div[text()=' Configurações ']")).click();

		driver.findElement(By.xpath("//span[text()=' Alterar ']")).click();

		WebElement address1 = driver.findElement(By.id("adr_AddressLine1"));
		actions.moveToElement(address1).click().sendKeys("1466 Bosque da Saude");
		...
		actions.moveToElement(city).click().sendKeys("Cuiaba");
		actions.build().perform();

		WebElement state = driver.findElement(By.id("adr_StateOrRegion"));
		actions.moveToElement(state).click().sendKeys("MT");
		actions.build().perform();

		WebElement zip = driver.findElement(By.id("adr_PostalCode"));
		actions.moveToElement(zip).click().sendKeys("78008000");
		actions.build().perform();
		...
		WebElement update = driver.findElement(By.xpath("//span[text()=' Atualizar ']"));
		...
		driver.findElement(By.xpath("//span[text()=' Editar a forma de pagamento ']")).click();

		driver.findElement(By.xpath("//span[text()='Utilize este endereço']")).click();

		driver.findElement(By.xpath("//span[text()='Adicione um cartão']")).click();
		...
		driver.findElement(By.xpath("(//li[text()='BR'])[1]")).click();

		driver.findElement(By.xpath("(//ul[@class='chosen-choices'])[2]")).click();

		driver.findElement(By.xpath("(//li[text()='BR'])[2]")).click();

		driver.findElement(By.xpath("(//ul[@class='chosen-choices'])[3]")).click();

		driver.findElement(By.xpath("(//li[text()='BR'])[3]")).click();
